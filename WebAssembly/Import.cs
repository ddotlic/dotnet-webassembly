...
public abstract class Import
{
    ...
    public class Table : Import
    {
        ...
        public Table(string module, string field, uint minimum, uint? maximum = null)
            : base(module, field) =>
            Definition = new WebAssembly.Table(minimum, maximum);
    ...
    public class Global : Import
    {
        ...
        /// </summary>
        public Global() => ContentType = WebAssemblyValueType.Int32;
        ...
        {
            ContentType = (WebAssemblyValueType)reader.ReadVarInt7();
        ...
        internal sealed override void WriteTo(Writer writer)
        {
            ...
            writer.WriteVar((sbyte)ContentType);
            writer.WriteVar(IsMutable ? 1u : 0);
        }
    }
}
